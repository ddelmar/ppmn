...
function listEvents(root, divId) {
  ...
  for (var i = 0; i < feed.entry.length; i++) {
	...
	function eventDate(){
		...
		spanDate.setAttribute('class', 'event-date');
		spanDate.appendChild(document.createTextNode(dateString));
		return spanDate;
	}
	
	function eventName(){
		var spanName = document.createElement('span');
		spanName.setAttribute('class', 'event-name');
		spanName.appendChild(document.createTextNode(title));
		return spanName;
	}
	...
	function eventDetails (){
		...
		eventDetails.appendChild(document.createTextNode(eventName + " - " + eventDate));
		*/
		return eventDate;
	}
	...
	entryLink.appendChild(eventName());
	entryLink.appendChild(eventDate());
