<?php require_once('../_/inc/doctype-html.php'); ?>
	<head>
		...
		<title>Events | PayPal Media Network</title>
	...
	<body>
		...
		fpti.pgrp = 'main:ppmn:advertising::events';
		fpti.page = 'main:ppmn:advertising::events:::';
		fpti.ccpg = 'usa';
		fpti.lgin = 'out';
		fpti.rsta = 'us-en';
		...
		<noscript><img src="https://tracking.qa.paypal.com/ts?nojs=1&amp;pgrp=main%3Appmn%3Aadvertising%3A%3Aevents" alt="" height="1" width="1" border="0" /></noscript>
		<!-- End FPTI code -->
	</body>
</html>